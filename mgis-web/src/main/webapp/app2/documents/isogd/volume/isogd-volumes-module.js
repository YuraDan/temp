	...
	.config(function ($stateProvider, $urlRouterProvider) {
		$stateProvider//
			.state("isogd.structure.volumes", {
				...
				templateUrl: "app2/documents/isogd/volume/isogd-volumes-list.htm",
				controller: function ($scope, $state, $stateParams, ISOGDVolumesService, $modal, MGISCommonsModalForm, $rootScope) {
					...
					function openEditVolumeForm(modalScope) {
						MGISCommonsModalForm.edit("app2/documents/isogd/volume/isogd-volume-form.htm", modalScope, function ($scope, $modalInstance) {
			...
			.state("isogd.volumes.edit", {
				url: "edit/:volumeId",
				templateUrl: "app2/documents/isogd/volume/isogd-volume-form.htm",
