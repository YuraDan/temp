	...
	.config(function ($stateProvider, $urlRouterProvider) {
		$stateProvider//
			.state("isogd.structure.books", {
				...
				templateUrl: "app2/documents/isogd/book/isogd-books-list.htm",
				controller: function ($scope, $state, $stateParams, ISOGDBooksService, $modal, MGISCommonsModalForm, $rootScope) {
					...
					function openEditBookForm(modalScope) {
						MGISCommonsModalForm.edit("app2/documents/isogd/book/isogd-book-form.htm", modalScope, function ($scope, $modalInstance) {
							$modalInstance.close();
