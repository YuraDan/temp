	...
	.config(function ($stateProvider, $urlRouterProvider) {
		$stateProvider //
			.state("isogd.structure.documents", {
				...
				templateUrl: "app2/documents/isogd/document/isogd-documents-list.htm",
			...
			ISOGDDocumentsService.loadDocumentClassByVolumeId(volumeId).then(function (documentClass) {
				if (documentClass.hasCommonPart) {
					...
					modalScope.commonPartUploadComplete = function (data) {
						...
						modalScope.document.commonPart.documentContents = modalScope.document.commonPart.documentContents || [];
				...
				MGISCommonsModalForm.edit("app2/documents/isogd/document/isogd-document-form.htm", modalScope,
