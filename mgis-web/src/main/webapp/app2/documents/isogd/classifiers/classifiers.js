...
//        $urlRouterProvider.when("/isogd/classifiers", "/isogd/classifiers/structure");
        $stateProvider //
            .state("isogd.classifiers", {
                url: "/classifiers",
                templateUrl: "app2/documents/isogd/classifiers/classifiers.htm",
            ...
            .state("isogd.classifiers.doctypes", {
                url: "/doctypes",
                templateUrl: "app2/documents/isogd/classifiers/documents/types/list.htm",
                controller: function ($scope, $state, $stateParams) {
            ...
            .state("isogd.classifiers.docstructure", {
                url: "/structure",
                templateUrl: "app2/documents/isogd/classifiers/documents/structure/isogd-docs-structure.htm",
                controller: function ($scope, $state, $stateParams) {
            ...
            .state("isogd.classifiers.docrepresentations", {
                url: "/representations",
                templateUrl: "app2/documents/isogd/classifiers/documents/representation/isogd-docs-representation-list.htm"
                /*,
                 controller: function ($scope, $state, $stateParams) {
