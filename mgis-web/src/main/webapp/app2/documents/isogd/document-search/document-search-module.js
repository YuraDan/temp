angular.module("mgis.isogd.documents.search", ["ui.router",
	...
	.config(function ($stateProvider) {
		$stateProvider
			.state("isogd.search", {
				url: "/search",
				templateUrl: "app2/documents/isogd/document-search/document-list.htm"
			});
	})
	...
	.directive("isogdDocumentSearch", function () {
		return {
			...
			templateUrl: "app2/documents/isogd/document-search/document-search-component.htm",
			controller: function ($scope, $rootScope, MGISCommonsModalForm,
				...
				$scope.extendedSearchClick = function () {
					...
					function openExtendedSearchForm(modalScope) {
						...
						MGISCommonsModalForm.edit("app2/documents/isogd/document-search/document-search-form.htm", modalScope, function (scope, modalInstance) {
								modalInstance.close();
	...
	.directive("isogdDocumentSearchFilter", function () {
		return {
			restrict: "E",
			scope: false,
			templateUrl: "app2/documents/isogd/document-search/document-search-component-filter.htm"
		}
	})
