angular.module("mgis.lands.land-selector", ["ui.bootstrap",
	...
	.directive("landsSelector", function () {
		return {
			...
			templateUrl: "app2/property/lands/land-selector/lands-selector-component.htm",
			controller: function ($scope, $rootScope, MGISCommonsModalForm, LandsLandCRUDService) {
				$scope.select = function () {
					...
					MGISCommonsModalForm.edit("app2/property/lands/land-selector/land-selector-search.htm", modalScope, function (scope, modalInstance) {
