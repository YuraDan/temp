angular.module("mgis.capital-constructs.construct", ["ui.router", "ui.bootstrap", "ui.mask", "ngCleanMask",
	...
	.config(function ($stateProvider) {
		$stateProvider
			.state("oks.constructs", {
				url: "/constructs/",
				templateUrl: "app2/property/oks/construct/construct-list.htm"
			});
	})
	.factory("CapitalConstructsConstructCRUDService", function ($rootScope,
		...
		function editItem0(item, updateHandler) {
			...
			CapitalConstructsConstructTypeService.get().then(function (constructTypePager) {
				...
				MGISCommonsModalForm.edit("app2/property/oks/construct/construct-form.htm", modalScope, function (scope, modalInstance) {
	...
	.controller("CapitalConstructsConstructController", function ($scope,
		...
		$scope.submenuStates =
			[
				{ name: 'included-objects', url: 'app2/property/oks/construct/construct-form-included-objects.htm'},
				{ name: 'parent-objects', url: 'app2/property/oks/construct/construct-form-parent-objects.htm'}
			];
