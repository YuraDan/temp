angular.module("mgis.capital-constructs.constructive-element-type", ["ui.bootstrap",
	...
	.directive("constructiveElementType", function () {
		return {
			...
			templateUrl: "app2/property/oks/constructive-element-type/constructive-element-type-selector.htm",
			controller: function ($scope,
				...
				$scope.openSelector = function () {
					...
					var modalInstance = MGISCommonsModalForm.edit("app2/property/oks/constructive-element-type/constructive-element-type-selector-list.htm", modalScope, function (scope, modalInstance) {
	...
	.factory("CapitalConstructsConstructiveElementTypeCRUDService", function ($rootScope,
		...
		function editItem(item, completeHandler) {
			...
			MGISCommonsModalForm.edit("app2/property/oks/constructive-element-type/constructive-element-type-form.htm", modalScope, function (scope, modalInstance) {
