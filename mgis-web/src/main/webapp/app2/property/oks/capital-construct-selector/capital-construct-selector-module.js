angular.module("mgis.capital-constructs.construct-selector", ["ui.bootstrap",
	...
	.directive("capitalConstructsSelector", function () {
		return {
			...
			templateUrl: "app2/property/oks/capital-construct-selector/capital-constructs-selector-component.htm",
			controller: function ($scope, $rootScope, MGISCommonsModalForm, CapitalConstructsConstructCRUDService) {
				...
				$scope.select = function () {
					...
					MGISCommonsModalForm.edit("app2/property/oks/capital-construct-selector/capital-construct-selector-search.htm", modalScope, function (scope, modalInstance) {
