...
import ru.sovzond.mgis2.documents.dao.isogd.classifiers.documents.DocumentClassDao;

/**
 * Created by Alexander Arakelyan on 22.06.15.
 */
@Service
public class DocumentClassService extends CRUDBeanBase<DocumentClass> {
