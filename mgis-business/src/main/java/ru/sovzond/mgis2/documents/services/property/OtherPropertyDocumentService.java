...
import ru.sovzond.mgis2.documents.dao.property.OtherPropertyDocumentDao;
 ...
 */
@Service
public class OtherPropertyDocumentService extends CRUDBeanBase<OtherPropertyDocument> {

	@Autowired
	private OtherPropertyDocumentDao dao;
