 ...
 */
@Repository
public class LandControlInspectionResultAvailabilityOfViolationsDao
		extends CRUDDaoBase<LandControlAvailabilityOfViolations>
		implements ILandControlInspectionResultAvailabilityOfViolationsDao {
}
